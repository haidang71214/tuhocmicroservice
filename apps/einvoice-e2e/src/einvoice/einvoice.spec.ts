...
import { InvoiceRequestDto as CreateInvoiceRequestDto, InvoiceResponseDto } from '@common/interfaces/gateway/invoice';

describe('Invoice E2E (HTTP)', () => {
  let accessToken: string;
  beforeAll(async () => {
    const res = (await getAccessToken()).accessToken;
    accessToken = res;
  });
